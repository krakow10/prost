...
impl serde::Serialize for Value {
        ...
        S: serde::Serializer,
    {
        match &self.kind {
            ...
            Some(value::Kind::NumberValue(v)) => serializer.serialize_f64(*v),
            Some(value::Kind::StringValue(v)) => serializer.serialize_str(v),
            Some(value::Kind::BoolValue(v)) => serializer.serialize_bool(*v),
            Some(value::Kind::StructValue(v)) => v.serialize(serializer),
            Some(value::Kind::ListValue(v)) => v.serialize(serializer),
...
impl<'de> serde::de::Visitor<'de> for KeyClassifier {
    ...
    {
        match s {
            _ => Ok(KeyClass::Map(::prost::alloc::string::String::from(s))),
        }
    }
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for ValueVisitor {
            ...
            fn visit_bool<E>(self, value: bool) -> Result<Value, E> {
                Ok(v(value::Kind::BoolValue(value)))
            }
            ...
            fn visit_i64<E:serde::de::Error>(self, value: i64) -> Result<Value, E> {
                ...
                match rounded as i64==value{
                    true=>Ok(v(value::Kind::NumberValue(value as f64))),
                    false=>Err(serde::de::Error::custom("i64 cannot be represented by f64")),
                }
            }

            #[inline]
            fn visit_u64<E>(self, value: u64) -> Result<Value, E> {
                Ok(v(value::Kind::NumberValue(value as f64)))
            }

            #[inline]
            fn visit_f64<E>(self, value: f64) -> Result<Value, E> {
                Ok(v(value::Kind::NumberValue(value)))
            }
            ...
            fn visit_string<E>(self, value: ::prost::alloc::string::String) -> Result<Value, E> {
                Ok(v(value::Kind::StringValue(value)))
            }

            #[inline]
            fn visit_none<E>(self) -> Result<Value, E> {
                Ok(v(value::Kind::NullValue(0)))
            }
                ...
                V: serde::de::SeqAccess<'de>,
            {
                ...
                Ok(v(value::Kind::ListValue(ListValue{values})))
            }
                ...
                V: serde::de::MapAccess<'de>,
            {
                match tri!(visitor.next_key_seed(KeyClassifier)) {
                    Some(KeyClass::Map(first_key)) => {
                        ...
                        fields.insert(first_key, tri!(visitor.next_value()));
                        while let Some((key, value)) = tri!(visitor.next_entry()) {
                            fields.insert(key, value);
                        }

                        Ok(v(value::Kind::StructValue(Struct{fields})))
                    }
                    None => Ok(v(value::Kind::StructValue(Struct{
                        fields: (::prost::alloc::collections::BTreeMap::new())
                    }))),
                }
            }
        }
